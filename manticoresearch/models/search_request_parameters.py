...
class SearchRequestParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["aggs", "expressions", "join", "highlight", "index", "limit", "max_matches", "offset", "options", "profile", "sort", "_source", "track_scores"]
