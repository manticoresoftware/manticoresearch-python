...
class GeoFilter(BaseModel):
    ...
    GeoFilter
    """ # noqa: E501
    geo_distance: Optional[GeoFilterGeoDistance] = None
    __properties: ClassVar[List[str]] = ["geo_distance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "geo_distance": GeoFilterGeoDistance.from_dict(obj["geo_distance"]) if obj.get("geo_distance") is not None else None
        })
        return _obj
