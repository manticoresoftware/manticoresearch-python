...
class AggregationCompositeSourcesInnerValue(BaseModel):
    """
    AggregationCompositeSourcesInnerValue
    """ # noqa: E501
    terms: Optional[AggregationCompositeSourcesInnerValueTerms] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "terms": AggregationCompositeSourcesInnerValueTerms.from_dict(obj["terms"]) if obj.get("terms") is not None else None
        })
        return _obj
