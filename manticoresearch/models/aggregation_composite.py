...
class AggregationComposite(BaseModel):
    """
    ...
    sources: Optional[List[Dict[str, AggregationCompositeSourcesInnerValue]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "size": obj.get("size"),
            "sources": [Dict[str, AggregationCompositeSourcesInnerValue].from_dict(_item) for _item in obj["sources"]] if obj.get("sources") is not None else None
        })
        return _obj
