...
class JoinOn(BaseModel):
    ...
    JoinOn
    """ # noqa: E501
    right: Optional[JoinCond] = None
    left: Optional[JoinCond] = None
    operator: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["right", "left", "operator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "right": JoinCond.from_dict(obj["right"]) if obj.get("right") is not None else None,
            "left": JoinCond.from_dict(obj["left"]) if obj.get("left") is not None else None,
