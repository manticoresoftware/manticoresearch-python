...
class JoinInnerOnInner(BaseModel):
    """
    JoinInnerOnInner
    """ # noqa: E501
    left: Optional[JoinInnerOnInnerLeft] = None
    operator: Optional[StrictStr] = None
    right: Optional[JoinBasicCond] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "left": JoinInnerOnInnerLeft.from_dict(obj["left"]) if obj.get("left") is not None else None,
            "operator": obj.get("operator"),
            "right": JoinBasicCond.from_dict(obj["right"]) if obj.get("right") is not None else None
        })
        return _obj
