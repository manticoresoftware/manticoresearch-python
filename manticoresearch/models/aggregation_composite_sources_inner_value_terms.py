...
class AggregationCompositeSourcesInnerValueTerms(BaseModel):
    """
    AggregationCompositeSourcesInnerValueTerms
    """ # noqa: E501
    var_field: Optional[StrictStr] = Field(default=None, description="Name of attribute to aggregate by", alias="field")
