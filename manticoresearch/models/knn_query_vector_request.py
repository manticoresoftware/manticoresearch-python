...
class KnnQueryVectorRequest(BaseModel):
    """
    KnnQueryVectorRequest
    """ # noqa: E501
    var_field: StrictStr = Field(alias="field")
    k: Optional[StrictInt] = None
    ef: Optional[StrictInt] = None
    query_vector: List[Union[StrictFloat, StrictInt]]
    __properties: ClassVar[List[str]] = ["field", "k", "ef", "query_vector"]
