...
class RangeFilterRangeValue(BaseModel):
    """
    RangeFilterRangeValue
    """ # noqa: E501
    lt: Optional[EqualsFilterEquals] = None
    gt: Optional[EqualsFilterEquals] = None
    lte: Optional[EqualsFilterEquals] = None
    gte: Optional[EqualsFilterEquals] = None
    __properties: ClassVar[List[str]] = ["lt", "gt", "lte", "gte"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lt": EqualsFilterEquals.from_dict(obj["lt"]) if obj.get("lt") is not None else None,
            "gt": EqualsFilterEquals.from_dict(obj["gt"]) if obj.get("gt") is not None else None,
            "lte": EqualsFilterEquals.from_dict(obj["lte"]) if obj.get("lte") is not None else None,
            "gte": EqualsFilterEquals.from_dict(obj["gte"]) if obj.get("gte") is not None else None
        })
        return _obj
